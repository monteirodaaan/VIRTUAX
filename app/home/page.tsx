...
function HomePageContent() {
  ...
  return (
    <div className="min-h-screen relative bg-background">
      <header className="fixed top-0 w-full border-gray-200 z-50 text-brand-foreground bg-gray-900 py-3 sm:py-4 border-b-0" role="banner">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <a href="#" className="text-gray-400 hover:text-brand transition-colors" aria-label="WhatsApp">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.031 6.172c-3.946 0-7.111 3.85-7.111 8.586 0 1.54.364 3.025 1.009 4.346L4.019 21.954l4.985-1.585c1.25.666 2.662 1.05 4.038 1.05 3.946 0 7.111-3.85 7.111-8.586 0-2.335-.898-4.538-2.534-6.201-1.636-1.663-3.849-2.562-6.12-2.562zm.031 15.388c-1.167 0-2.308-.298-3.314-.868l-.237-.134-2.582.823.844-2.7-.173-.275a7.047 7.047 0 01-1.062-3.946c0-3.872 3.236-7.02 7.214-7.02s7.214 3.148 7.214 7.02c0 3.872-3.236 7.02-7.214 7.02zm3.216-5.13c-.576-.288-3.415-1.687-3.947-1.88-.532-.198-.919-.297-1.306.297-.388.594-1.487 1.88-1.823 2.266-.336.386-.672.433-1.248.145-1.830-.9-3.035-2.537-3.71-4.247-.237-.652.25-.6.809-1.995.112-.26.056-.484-.03-.677-.087-.193-.772-1.863-.999-2.55-.215-.512-.432-.525-.772-.534-.2-.009-.424-.009-.648-.009-.224 0-.591.055-.901.297-.31.242-1.18 1.154-1.18 2.801 0 1.647 1.208 3.25 1.375 3.476.167.226 2.367 3.613 5.735 5.062.8.34 1.435.544 1.926.701.802.259 1.533.224 2.11.135.643-.101 1.987-.812 2.266-1.596.279-.784.279-1.453.195-1.596-.083-.143-.303-.234-.657-.401z"/>
                  </svg>
                </a>
              </div>
            </div>
