            ...
            <div className="flex flex-col gap-5">
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <a href="mailto:contato@virtuax.com.br" className="text-sm text-gray-400 hover:text-brand transition-colors duration-200">contato@virtuax.com.br</a>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-400 leading-relaxed">Segunda a Sexta das 08h às 18h<br />Sábado das 08h às 12h</span>
                </li>
                <li className="flex items-start gap-3">
