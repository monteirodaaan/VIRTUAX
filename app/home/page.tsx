...
function HomePageContent() {
  ...
  return (
    <div className="min-h-screen relative bg-background">
      ...
      <footer className="bg-gray-900 text-white" aria-label="Rodapé Virtuax">
        <div className="w-full max-w-7xl mx-auto px-6 md:px-10 lg:px-16">

          {/* Grade principal — 4 colunas */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 py-14 border-b border-gray-800">
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                <Image
                  src="/images/logo.webp"
                  alt="Virtuax Internet Fibra Óptica"
                  width={140}
                  height={36}
              ...
              <div className="flex items-center gap-4 pt-1">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Virtuax no Facebook" className="text-brand hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Virtuax no Instagram" className="text-brand hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://wa.me/558007315050" target="_blank" rel="noopener noreferrer" aria-label="Virtuax no WhatsApp" className="text-brand hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="mailto:contato@virtuax.com.br" aria-label="Enviar e-mail para Virtuax" className="text-brand hover:text-white transition-colors">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-500">Cobertura</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
            ...
            <nav aria-label="Links do rodapé">
              <div className="flex flex-col gap-4">
                <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-500">Links</h3>
            ...
            <address className="not-italic flex flex-col gap-4">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-500">Suporte</h3>
              <ul className="flex flex-col gap-3">
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-brand shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25z" />
                  </svg>
                  <a href="tel:08007315050" className="text-sm text-gray-400 hover:text-white transition-colors">0800 731 5050</a>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-brand shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                  </svg>
                  <a href="mailto:contato@virtuax.com.br" className="text-sm text-gray-400 hover:text-white transition-colors">contato@virtuax.com.br</a>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-brand shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
            <p className="text-xs text-gray-500 text-center sm:text-left leading-relaxed">
              © 2026 Virtuax. Todos os direitos reservados &mdash; Dev.{" "}
              <a href="https://www.instagram.com/november.mkt" target="_blank" rel="noopener noreferrer" className="text-brand font-semibold hover:underline">November Marketing</a>{" "}
              &mdash; Design{" "}
              <a href="https://dm.art.br/" target="_blank" rel="noopener noreferrer" className="text-brand font-semibold hover:underline">dm.art.br</a>
            </p>
            <nav aria-label="Links legais" className="flex items-center gap-5">
              ...
              <a href="#" className="text-xs text-gray-500 hover:text-white transition-colors">LGPD</a>
            </nav>
          </div>
