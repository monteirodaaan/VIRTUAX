            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <a href="#" className="text-gray-400 hover:text-brand transition-colors" aria-label="WhatsApp">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19.07 4.93a10 10 0 0 0-14.14 0 10 10 0 1 0 14.14 14.14A10 10 0 0 0 19.07 4.93zm-7.07 16a8 8 0 1 1 0-16 8 8 0 0 1 0 16zm3.5-9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-5 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm8-3a4 4 0 0 0-7.5 1.5h3a1 1 0 1 1 0 2h-3A4 4 0 0 0 18 8z"/>
                  </svg>
                </a>
              </div>
